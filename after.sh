...
###################################################
# THIS IS TO INCREASE MYSQL DISK ESPACE
###################################################
#
# lvextend -L20G -r homestead-vg/mysql-master

###################################################
# This is to update the PUBLICKEY of heroku reopsitory
###################################################
#
# curl https://cli-assets.heroku.com/apt/release.key | sudo apt-key add -

###################################################
# share local site with internet
###################################################
#
# tailscale serve https / http://127.0.0.1:8080

sudo bash -c 'echo "none" > /sys/block/sda/queue/scheduler'
